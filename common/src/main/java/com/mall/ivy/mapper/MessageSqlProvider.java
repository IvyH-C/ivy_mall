...
import com.mall.ivy.model.MessageExample.Criteria;
import com.mall.ivy.model.MessageExample.Criterion;
...
public class MessageSqlProvider {
    ...
    public String insertSelective(Message record) {
        ...
        if (record.getReceiver() != null) {
            sql.VALUES("receiver", "#{receiver,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getReceiver() != null) {
            sql.SET("receiver = #{record.receiver,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Message record) {
        ...
        if (record.getReceiver() != null) {
            sql.SET("receiver = #{receiver,jdbcType=INTEGER}");
        }
