...
import com.mall.ivy.model.DeliveryExample.Criteria;
import com.mall.ivy.model.DeliveryExample.Criterion;
import com.mall.ivy.model.DeliveryExample;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class DeliverySqlProvider {

    public String countByExample(DeliveryExample example) {
        SQL sql = new SQL();
    ...
    public String deleteByExample(DeliveryExample example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("delivery");
        applyWhere(sql, example, false);
        return sql.toString();
    }

    public String insertSelective(Delivery record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("delivery");
    ...
    public String selectByExample(DeliveryExample example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        Delivery record = (Delivery) parameter.get("record");
        DeliveryExample example = (DeliveryExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(Delivery record) {
        SQL sql = new SQL();
        sql.UPDATE("delivery");
    ...
    protected void applyWhere(SQL sql, DeliveryExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
