...
import com.mall.ivy.model.GoodsExample.Criteria;
import com.mall.ivy.model.GoodsExample.Criterion;
...
public class GoodsSqlProvider {
    ...
    public String insertSelective(Goods record) {
        ...
        if (record.getMainImg() != null) {
            sql.VALUES("main_img", "#{mainImg,jdbcType=VARCHAR}");
        }
        
        if (record.getSubImg() != null) {
            sql.VALUES("sub_img", "#{subImg,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getMainImg() != null) {
            sql.SET("main_img = #{record.mainImg,jdbcType=VARCHAR}");
        }
        
        if (record.getSubImg() != null) {
            sql.SET("sub_img = #{record.subImg,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(Goods record) {
        ...
        if (record.getMainImg() != null) {
            sql.SET("main_img = #{mainImg,jdbcType=VARCHAR}");
        }
        
        if (record.getSubImg() != null) {
            sql.SET("sub_img = #{subImg,jdbcType=VARCHAR}");
        }
